...
void CL_Init( void ) {
	...
	sacc_maxpackets = Cvar_Get ("cl_maxpackets", "60", CVAR_ARCHIVE );
	sacc_packetdup = Cvar_Get ("cl_packetdup", "1", CVAR_ARCHIVE );
	...
	Cvar_Get ("sacc_rate", "60000", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("rate", "60000", CVAR_USERINFO | CVAR_ARCHIVE );
